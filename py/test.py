...
time.sleep(2)
driver.find_element_by_css_selector('#mat-input-0').send_keys("a7d9fa12f@mailsac.com")
driver.find_element_by_css_selector('#mat-input-1').send_keys("a7d9fa12f@mailsac.com")
