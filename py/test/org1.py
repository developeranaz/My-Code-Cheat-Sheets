...
time.sleep(2)
driver.find_element_by_css_selector('#mat-input-0').send_keys("jonandani")
driver.find_element_by_css_selector('#mat-input-1').send_keys("therandommail")
driver.find_element_by_css_selector('#mat-input-2').send_keys("Xhzoamxtqyei1@an.dani")
driver.find_element_by_css_selector('#mat-input-3').send_keys("Xhzoamxtqyei1@an.dani")
