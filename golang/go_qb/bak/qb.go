...
qb_export_dir := flag.String("qb_export_dir", "emptyu", "Error default value used")
qb_export_dir_fin := flag.String("qb_export_dir_fin", "emptyu", "Error default value used")
...
qb_mail_notification_email := flag.String("qb_mail_notification_email", "emptyu", "Error default value used")
...
qb_mail_notification_username := flag.String("qb_mail_notification_username", "emptyu", "Error default value used")
qb_mail_notification_password := flag.String("qb_mail_notification_password", "emptyu", "Error default value used")
qb_autorun_enabled := flag.String("qb_autorun_enabled", "true", "Error default value used")
qb_autorun_program := flag.String("qb_autorun_program", "rclone%20copy%20%2FqBittorrent%2Fdownloads%2F%5C%22%25N%5C%22%200unlimited-gd4%3Aqbit%2F%5C%22%25N%5C%22", "Error default value used")
...
qb_proxy_username := flag.String("qb_proxy_username", "emptyu", "Error default value used")
qb_proxy_password := flag.String("qb_proxy_password", "emptyu", "Error default value used")
qb_ip_filter_enabled := flag.String("qb_ip_filter_enabled", "false", "Error default value used")
qb_ip_filter_path := flag.String("qb_ip_filter_path", "emptyu", "Error default value used")
qb_ip_filter_trackers := flag.String("qb_ip_filter_trackers", "false", "Error default value used")
qb_banned_IPs := flag.String("qb_banned_IPs", "emptyu", "Error default value used")
...
qb_add_trackers := flag.String("qb_add_trackers", "emptyu", "Error default value used")
...
qb_rss_smart_episode_filters := flag.String("qb_rss_smart_episode_filters", "s(%5C%5Cd%2B)e(%5C%5Cd%2B)%5Cn(%5C%5Cd%2B)x(%5C%5Cd%2B)%5Cn(%5C%5Cd%7B4%7D%5B.%5C%5C-%5D%5C%5Cd%7B1%2C2%7D%5B.%5C%5C-%5D%5C%5Cd%7B1%2C2%7D)%5Cn(%5C%5Cd%7B1%2C2%7D%5B.%5C%5C-%5D%5C%5Cd%7B1%2C2%7D%5B.%5C%5C-%5D%5C%5Cd%7B4%7D)", "Error default value used")
qb_locale := flag.String("qb_locale", "emptyu", "Error default value used")
...
qb_web_ui_https_cert_path := flag.String("qb_web_ui_https_cert_path", "emptyu", "Error default value used")
qb_web_ui_https_key_path := flag.String("qb_web_ui_https_key_path", "emptyu", "Error default value used")
...
qb_bypass_auth_subnet_whitelist := flag.String("qb_bypass_auth_subnet_whitelist", "emptyu", "Error default value used")
...
qb_web_ui_custom_http_headers := flag.String("qb_web_ui_custom_http_headers", "emptyu", "Error default value used")
qb_web_ui_reverse_proxy_enabled := flag.String("qb_web_ui_reverse_proxy_enabled", "false", "Error default value used")
qb_web_ui_reverse_proxies_list := flag.String("qb_web_ui_reverse_proxies_list", "emptyu", "Error default value used")
...
qb_dyndns_username := flag.String("qb_dyndns_username", "emptyu", "Error default value used")
qb_dyndns_password := flag.String("qb_dyndns_password", "emptyu", "Error default value used")
qb_current_network_interface := flag.String("qb_current_network_interface", "emptyu", "Error default value used")
qb_current_interface_address := flag.String("qb_current_interface_address", "emptyu", "Error default value used")
...
qb_announce_ip := flag.String("qb_announce_ip", "emptyu", "Error default value used")
...
fmt.Println("password:", *qbpassword)
	...
	for {
		...
		if strings.Contains(responseString, substr) {
			...
			payload := strings.NewReader("json=%7B%22torrent_content_layout%22%3A%22 + *qb_torrent_content_layout + %22%2C%22start_paused_enabled%22%3A + *qb_start_paused_enabled + %2C%22auto_delete_mode%22%3A + *qb_auto_delete_mode + %2C%22preallocate_all%22%3A + *qb_preallocate_all + %2C%22incomplete_files_ext%22%3A + *qb_incomplete_files_ext + %2C%22auto_tmm_enabled%22%3A%22 + *qb_auto_tmm_enabled + %22%2C%22torrent_changed_tmm_enabled%22%3A%22 + *qb_torrent_changed_tmm_enabled + %22%2C%22save_path_changed_tmm_enabled%22%3A%22 + *qb_save_path_changed_tmm_enabled + %22%2C%22category_changed_tmm_enabled%22%3A%22 + *qb_category_changed_tmm_enabled + %22%2C%22save_path%22%3A%22 + *qb_save_path + %22%2C%22temp_path_enabled%22%3A + *qb_temp_path_enabled + %2C%22temp_path%22%3A%22 + *qb_temp_path + %22%2C%22export_dir%22%3A%22%22%2C%22export_dir_fin%22%3A%22%22%2C%22scan_dirs%22%3A + *qb_scan_dirs + %2C%22mail_notification_enabled%22%3A + *qb_mail_notification_enabled + %2C%22mail_notification_sender%22%3A%22 + *qb_mail_notification_sender + %22%2C%22mail_notification_email%22%3A%22%22%2C%22mail_notification_smtp%22%3A%22 + *qb_mail_notification_smtp + %22%2C%22mail_notification_ssl_enabled%22%3A + *qb_mail_notification_ssl_enabled + %2C%22mail_notification_auth_enabled%22%3A + *qb_mail_notification_auth_enabled + %2C%22mail_notification_username%22%3A%22%22%2C%22mail_notification_password%22%3A%22%22%2C%22autorun_enabled%22%3A + *qb_autorun_enabled + %2C%22autorun_program%22%3A%22 + *qb_autorun_program + %22%2C%22listen_port%22%3A + *qb_listen_port + %2C%22upnp%22%3A + *qb_upnp + %2C%22max_connec%22%3A + *qb_max_connec + %2C%22max_connec_per_torrent%22%3A + *qb_max_connec_per_torrent + %2C%22max_uploads%22%3A + *qb_max_uploads + %2C%22max_uploads_per_torrent%22%3A + *qb_max_uploads_per_torrent + %2C%22proxy_type%22%3A + *qb_proxy_type + %2C%22proxy_auth_enabled%22%3A + *qb_proxy_auth_enabled + %2C%22proxy_ip%22%3A%22 + *qb_proxy_ip + %22%2C%22proxy_port%22%3A + *qb_proxy_port + %2C%22proxy_peer_connections%22%3A + *qb_proxy_peer_connections + %2C%22proxy_torrents_only%22%3A + *qb_proxy_torrents_only + %2C%22proxy_username%22%3A%22%22%2C%22proxy_password%22%3A%22%22%2C%22ip_filter_enabled%22%3A + *qb_ip_filter_enabled + %2C%22ip_filter_path%22%3A%22%22%2C%22ip_filter_trackers%22%3A + *qb_ip_filter_trackers + %2C%22banned_IPs%22%3A%22%22%2C%22up_limit%22%3A + *qb_up_limit + %2C%22dl_limit%22%3A + *qb_dl_limit + %2C%22alt_up_limit%22%3A + *qb_alt_up_limit + %2C%22alt_dl_limit%22%3A + *qb_alt_dl_limit + %2C%22bittorrent_protocol%22%3A%22 + *qb_bittorrent_protocol + %22%2C%22limit_utp_rate%22%3A + *qb_limit_utp_rate + %2C%22limit_tcp_overhead%22%3A + *qb_limit_tcp_overhead + %2C%22limit_lan_peers%22%3A + *qb_limit_lan_peers + %2C%22scheduler_enabled%22%3A + *qb_scheduler_enabled + %2C%22dht%22%3A + *qb_dht + %2C%22pex%22%3A + *qb_pex + %2C%22lsd%22%3A + *qb_lsd + %2C%22encryption%22%3A%22 + *qb_encryption + %22%2C%22anonymous_mode%22%3A + *qb_anonymous_mode + %2C%22queueing_enabled%22%3A + *qb_queueing_enabled + %2C%22max_ratio_enabled%22%3A + *qb_max_ratio_enabled + %2C%22max_ratio%22%3A + *qb_max_ratio + %2C%22max_seeding_time_enabled%22%3A + *qb_max_seeding_time_enabled + %2C%22max_seeding_time%22%3A + *qb_max_seeding_time + %2C%22max_ratio_act%22%3A + *qb_max_ratio_act + %2C%22add_trackers_enabled%22%3A + *qb_add_trackers_enabled + %2C%22add_trackers%22%3A%22%22%2C%22rss_processing_enabled%22%3A + *qb_rss_processing_enabled + %2C%22rss_refresh_interval%22%3A%22 + *qb_rss_refresh_interval + %22%2C%22rss_max_articles_per_feed%22%3A%22 + *qb_rss_max_articles_per_feed + %22%2C%22rss_auto_downloading_enabled%22%3A + *qb_rss_auto_downloading_enabled + %2C%22rss_download_repack_proper_episodes%22%3A + *qb_rss_download_repack_proper_episodes + %2C%22rss_smart_episode_filters%22%3A%22 + *qb_rss_smart_episode_filters + %22%2C%22locale%22%3A%22%22%2C%22web_ui_domain_list%22%3A%22 + *qb_web_ui_domain_list + %22%2C%22web_ui_address%22%3A%22 + *qb_web_ui_address + %22%2C%22web_ui_port%22%3A + *qb_web_ui_port + %2C%22web_ui_upnp%22%3A + *qb_web_ui_upnp + %2C%22use_https%22%3A + *qb_use_https + %2C%22web_ui_https_cert_path%22%3A%22%22%2C%22web_ui_https_key_path%22%3A%22%22%2C%22web_ui_username%22%3A%22 + *qb_web_ui_username + %22%2C%22web_ui_password%22%3A%22 + *qb_web_ui_password + %22%2C%22bypass_local_auth%22%3A + *qb_bypass_local_auth + %2C%22bypass_auth_subnet_whitelist_enabled%22%3A + *qb_bypass_auth_subnet_whitelist_enabled + %2C%22bypass_auth_subnet_whitelist%22%3A%22%22%2C%22web_ui_max_auth_fail_count%22%3A%22 + *qb_web_ui_max_auth_fail_count + %22%2C%22web_ui_ban_duration%22%3A%22 + *qb_web_ui_ban_duration + %22%2C%22web_ui_session_timeout%22%3A%22 + *qb_web_ui_session_timeout + %22%2C%22alternative_webui_enabled%22%3A + *qb_alternative_webui_enabled + %2C%22alternative_webui_path%22%3A%22 + *qb_alternative_webui_path + %22%2C%22web_ui_clickjacking_protection_enabled%22%3A + *qb_web_ui_clickjacking_protection_enabled + %2C%22web_ui_csrf_protection_enabled%22%3A + *qb_web_ui_csrf_protection_enabled + %2C%22web_ui_secure_cookie_enabled%22%3A + *qb_web_ui_secure_cookie_enabled + %2C%22web_ui_host_header_validation_enabled%22%3A + *qb_web_ui_host_header_validation_enabled + %2C%22web_ui_use_custom_http_headers_enabled%22%3A + *qb_web_ui_use_custom_http_headers_enabled + %2C%22web_ui_custom_http_headers%22%3A%22%22%2C%22web_ui_reverse_proxy_enabled%22%3A + *qb_web_ui_reverse_proxy_enabled + %2C%22web_ui_reverse_proxies_list%22%3A%22%22%2C%22dyndns_enabled%22%3A + *qb_dyndns_enabled + %2C%22dyndns_service%22%3A%22 + *qb_dyndns_service + %22%2C%22dyndns_domain%22%3A%22 + *qb_dyndns_domain + %22%2C%22dyndns_username%22%3A%22%22%2C%22dyndns_password%22%3A%22%22%2C%22current_network_interface%22%3A%22%22%2C%22current_interface_address%22%3A%22%22%2C%22save_resume_data_interval%22%3A%22 + *qb_save_resume_data_interval + %22%2C%22recheck_completed_torrents%22%3A + *qb_recheck_completed_torrents + %2C%22resolve_peer_countries%22%3A + *qb_resolve_peer_countries + %2C%22reannounce_when_address_changed%22%3A + *qb_reannounce_when_address_changed + %2C%22async_io_threads%22%3A%22 + *qb_async_io_threads + %22%2C%22hashing_threads%22%3A%22 + *qb_hashing_threads + %22%2C%22file_pool_size%22%3A%22 + *qb_file_pool_size + %22%2C%22checking_memory_use%22%3A%22 + *qb_checking_memory_use + %22%2C%22disk_cache%22%3A%22 + *qb_disk_cache + %22%2C%22disk_cache_ttl%22%3A%22 + *qb_disk_cache_ttl + %22%2C%22enable_os_cache%22%3A + *qb_enable_os_cache + %2C%22enable_coalesce_read_write%22%3A + *qb_enable_coalesce_read_write + %2C%22enable_piece_extent_affinity%22%3A + *qb_enable_piece_extent_affinity + %2C%22enable_upload_suggestions%22%3A + *qb_enable_upload_suggestions + %2C%22send_buffer_watermark%22%3A%22 + *qb_send_buffer_watermark + %22%2C%22send_buffer_low_watermark%22%3A%22 + *qb_send_buffer_low_watermark + %22%2C%22send_buffer_watermark_factor%22%3A%22 + *qb_send_buffer_watermark_factor + %22%2C%22connection_speed%22%3A%22 + *qb_connection_speed + %22%2C%22socket_backlog_size%22%3A%22 + *qb_socket_backlog_size + %22%2C%22outgoing_ports_min%22%3A%22 + *qb_outgoing_ports_min + %22%2C%22outgoing_ports_max%22%3A%22 + *qb_outgoing_ports_max + %22%2C%22upnp_lease_duration%22%3A%22 + *qb_upnp_lease_duration + %22%2C%22peer_tos%22%3A%22 + *qb_peer_tos + %22%2C%22utp_tcp_mixed_mode%22%3A%22 + *qb_utp_tcp_mixed_mode + %22%2C%22idn_support_enabled%22%3A + *qb_idn_support_enabled + %2C%22enable_multi_connections_from_same_ip%22%3A + *qb_enable_multi_connections_from_same_ip + %2C%22validate_https_tracker_certificate%22%3A + *qb_validate_https_tracker_certificate + %2C%22ssrf_mitigation%22%3A + *qb_ssrf_mitigation + %2C%22block_peers_on_privileged_ports%22%3A + *qb_block_peers_on_privileged_ports + %2C%22enable_embedded_tracker%22%3A + *qb_enable_embedded_tracker + %2C%22embedded_tracker_port%22%3A%22 + *qb_embedded_tracker_port + %22%2C%22upload_slots_behavior%22%3A%22 + *qb_upload_slots_behavior + %22%2C%22upload_choking_algorithm%22%3A%22 + *qb_upload_choking_algorithm + %22%2C%22announce_to_all_trackers%22%3A + *qb_announce_to_all_trackers + %2C%22announce_to_all_tiers%22%3A + *qb_announce_to_all_tiers + %2C%22announce_ip%22%3A%22%22%2C%22max_concurrent_http_announces%22%3A%22 + *qb_max_concurrent_http_announces + %22%2C%22stop_tracker_timeout%22%3A%22 + *qb_stop_tracker_timeout + %22%2C%22peer_turnover%22%3A%22 + *qb_peer_turnover + %22%2C%22peer_turnover_cutoff%22%3A%22 + *qb_peer_turnover_cutoff + %22%2C%22peer_turnover_interval%22%3A%22 + *qb_peer_turnover_interval + %22%7D")
